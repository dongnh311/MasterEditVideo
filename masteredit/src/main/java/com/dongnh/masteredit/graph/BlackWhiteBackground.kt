 ...
 * Phone : +84397199197.
 */
class BlackWhiteBackground(private val context: Context) :
    ...
    init {
        this@BlackWhiteBackground.vertexShaderSource = BLACK_WHITE_VERTEXT_SHADER
        this@BlackWhiteBackground.fragmentShaderSource = BLACK_WHITE_FRAGMENT_SHADER
        initBitmapLUT()
    }
    ...
    private fun initBitmapLUT() {
        bitmap =
            BitmapFactory.decodeStream(context.assets.open("graph/resource/blackwhite/back.png"))
    ...
    override fun onDraw() {
        ...
        GLES20.glUniform1f(getHandle("zoom"), zoom)
        GLES20.glUniform1i(getHandle("inputImageLUT"), 3)
